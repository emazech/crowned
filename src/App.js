...
import SaveTheCheese from "./SaveTheCheese/Components/WordToGuess";
    ...
    <Router>
      <div>
        <Routes>
          ...
          {user && <Route path="/choose-game" element={<ChooseGame />} />}
          ...
          {user ? (
            ...
            <Route path="*" element={<Navigate to="/choose-game" />} />
          )}
        </Routes>
      </div>
      </Router>
